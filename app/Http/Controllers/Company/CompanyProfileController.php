...
class CompanyProfileController extends Controller
{
  public function editDetails()
  {
    ...
    $data['contacts'] = isset(auth()->user()->company->contacts[0]) ? auth()->user()->company->contacts : [];
    $data['bankAccounts'] = isset(auth()->user()->company->bankAccounts[0]) ? auth()->user()->company->bankAccounts : [];
    $data['addresses'] = isset(auth()->user()->company->addresses[0]) ? auth()->user()->company->addresses : [];
