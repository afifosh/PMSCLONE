...
class BroadcastSettingController extends Controller
{
  ...
  public function index()
  {
    ...
    return view('admin.pages.settings.broadcast.index', ['setting' => $this->service->getFormattedDeliverySettings([optional($default)->value, 'default_broadcast_driver_name'])]);
  }
