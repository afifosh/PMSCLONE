...
class SmtpClient extends AbstractSmtpClient implements SupportSaveToSentFolderParameter
{
     ...
     * Send mail message
     *
     * @return null|\App\Innoclapps\Contracts\MailClient\MessageInterface
     */
     ...
     *
     * @param \App\Innoclapps\MailClient\Outlook\Message|null $repliesTo
     *
     * @return array
     */
     ...
     *
     * @param \App\Innoclapps\MailClient\Outlook\Message $message
     ...
     *
     * @return boolean|\Microsoft\Graph\Model\OpenTypeExtension
     */
