...
class InvoiceRepository {
    ...
    public function search($id = '', $data = array()) {
        ...
        //joins
        $invoices->leftJoin('companies as clients', 'clients.id', '=', 'invoices.bill_clientid');
        $invoices->leftJoin('projects', 'projects.id', '=', 'invoices.bill_projectid');
    ...
    public function processAffiliateEarnings($invoice_id = '') {
        ...
        //get the invoice
        $project = \App\Models\Project::Where('id', $invoice->bill_projectid)->first();
