...
/***/ "./resources/assets/vendor/libs/file-manager/jstree.min.js":
/*!*****************************************************************!*\
  !*** ./resources/assets/vendor/libs/file-manager/jstree.min.js ***!
  \*****************************************************************/
...
!function (a) {
  ...
  if (!a.jstree) {
    ...
    !j && k && (j = function j(a, b) {
      ...
      keyboard: {
        "ctrl-space": function ctrlSpace(b) {
      ...
      _kbevent_to_func: function _kbevent_to_func(a) {
        var b = {
            8: "Backspace",
            9: "Tab",
            13: "Enter",
      ...
      _load_node: function _load_node(b, c) {
        ...
        return d ? a.vakata.is_function(d) ? d.call(this, b, a.proxy(function (d) {
        ...
        }, this)) : "object" == _typeof(d) ? d.url ? (d = a.extend(!0, {}, d), a.vakata.is_function(d.url) && (d.url = d.url.call(this, b)), a.vakata.is_function(d.data) && (d.data = d.data.call(this, b)), a.ajax(d).done(a.proxy(function (d, e, g) {
        ...
        }, this))) : (e = a.vakata.is_array(d) ? a.extend(!0, [], d) : a.isPlainObject(d) ? a.extend(!0, {}, d) : d, b.id === a.jstree.root ? this._append_json_data(b, e, function (a) {
          c.call(this, a);
        }) : (this._data.core.last_error = {
          error: "nodata",
          plugin: "core",
      ...
      _node_changed: function _node_changed(b) {
            ...
            i = function i(a, b) {
              ...
              var c = a.dat,
                ...
                s = function s(a, c, d) {
                  ...
                  if (a && "object" == _typeof(a.state)) for (f in a.state) a.state.hasOwnProperty(f) && (m.state[f] = a.state[f]);
                  if (a && "object" == _typeof(a.li_attr)) for (f in a.li_attr) a.li_attr.hasOwnProperty(f) && (m.li_attr[f] = a.li_attr[f]);
                  if (m.li_attr.id || (m.li_attr.id = e), a && "object" == _typeof(a.a_attr)) for (f in a.a_attr) a.a_attr.hasOwnProperty(f) && (m.a_attr[f] = a.a_attr[f]);
                ...
                t = function t(a, c, d) {
                  ...
                  if (a && "object" == _typeof(a.state)) for (f in a.state) a.state.hasOwnProperty(f) && (o.state[f] = a.state[f]);
                  if (a && "object" == _typeof(a.li_attr)) for (f in a.li_attr) a.li_attr.hasOwnProperty(f) && (o.li_attr[f] = a.li_attr[f]);
                  if (o.li_attr.id && !o.id && (o.id = o.li_attr.id.toString()), o.id || (o.id = e), o.li_attr.id || (o.li_attr.id = o.id), a && "object" == _typeof(a.a_attr)) for (f in a.a_attr) a.a_attr.hasOwnProperty(f) && (o.a_attr[f] = a.a_attr[f]);
      ...
      _parse_model_from_flat_json: function _parse_model_from_flat_json(a, c, d) {
        ...
        if (a && "object" == _typeof(a.state)) for (h in a.state) a.state.hasOwnProperty(h) && (l.state[h] = a.state[h]);
        if (a && "object" == _typeof(a.li_attr)) for (h in a.li_attr) a.li_attr.hasOwnProperty(h) && (l.li_attr[h] = a.li_attr[h]);
        if (l.li_attr.id || (l.li_attr.id = e), a && "object" == _typeof(a.a_attr)) for (h in a.a_attr) a.a_attr.hasOwnProperty(h) && (l.a_attr[h] = a.a_attr[h]);
      ...
      _parse_model_from_json: function _parse_model_from_json(a, c, d) {
        ...
        if (a && "object" == _typeof(a.state)) for (f in a.state) a.state.hasOwnProperty(f) && (l.state[f] = a.state[f]);
        if (a && "object" == _typeof(a.li_attr)) for (f in a.li_attr) a.li_attr.hasOwnProperty(f) && (l.li_attr[f] = a.li_attr[f]);
        if (l.li_attr.id && !l.id && (l.id = l.li_attr.id.toString()), l.id || (l.id = e), l.li_attr.id || (l.li_attr.id = l.id), a && "object" == _typeof(a.a_attr)) for (f in a.a_attr) a.a_attr.hasOwnProperty(f) && (l.a_attr[f] = a.a_attr[f]);
        if (a && a.children && a.children.length) {
    ...
    l.className = "jstree-icon jstree-checkbox", l.setAttribute("role", "presentation"), a.jstree.defaults.checkbox = {
      ...
      this.bind = function () {
        ...
        var g = this.settings.contextmenu,
          ...
          j = !1,
          k = !1;
        (g.show_at_node || d === b || e === b) && (j = i.offset(), d = j.left, e = j.top + this._data.core.li_height), this.settings.contextmenu.select_node && !this.is_selected(c) && this.activate_node(c, f), k = g.items, a.vakata.is_function(k) && (k = k.call(this, c, a.proxy(function (a) {
      ...
      a.vakata.context = {
        ...
        _parse: function _parse(b, d) {
          ...
          return d && (e += "<ul>"), a.each(b, function (b, d) {
            return d ? (c.items.push(d), !f && d.separator_before && (e += "<li class='vakata-context-separator'><a href='#' " + (a.vakata.context.settings.icons ? "" : 'style="margin-left:0px;"') + ">&#160;</a></li>"), f = !1, e += "<li class='" + (d._class || "") + (d._disabled === !0 || a.vakata.is_function(d._disabled) && d._disabled({
              item: d,
              reference: c.reference,
              element: c.element
    ...
    a.jstree.plugins.dnd = function (b, c) {
      ...
      this.init = function (a, b) {
        ...
        if (!e) {
          ...
          if (this._data.massload = {}, h.length) {
            if (a.vakata.is_function(g)) return g.call(this, h, a.proxy(function (a) {
              var g, h;
            ...
            if ("object" == _typeof(g) && g && g.url) return g = a.extend(!0, {}, g), a.vakata.is_function(g.url) && (g.url = g.url.call(this, h)), a.vakata.is_function(g.data) && (g.data = g.data.call(this, h)), a.ajax(g).done(a.proxy(function (a, g, h) {
              var i, j;
      ...
      this.bind = function () {
        ...
        var i = this.settings.search,
          ...
          o,
          p;
        if (this._data.search.res.length && !g && this.clear_search(), e === b && (e = i.show_only_matches), h === b && (h = i.show_only_matches_children), !d && j !== !1) return a.vakata.is_function(j) ? j.call(this, c, a.proxy(function (b) {
      ...
      this.init = function (c, e) {
        ...
        this.element.on("model.jstree", a.proxy(function (c, d) {
          ...
          for (h = 0, i = f.length; i > h; h++) {
            ...
            if (g[j].a_attr !== b && "object" == _typeof(g[j].a_attr)) for (k in g[j].a_attr) if (g[j].a_attr.hasOwnProperty(k)) {
              if ("id" === k) continue;
        ...
        if (l = this.get_node(c, !0), l && l.length && (m = l.children(".jstree-anchor")), i = c.type, j = this.get_icon(c), c.type = d, (j === !0 || !f[i] || f[i].icon !== b && j === f[i].icon) && this.set_icon(c, f[d].icon !== b ? f[d].icon : !0), f[i] && f[i].li_attr !== b && "object" == _typeof(f[i].li_attr)) for (k in f[i].li_attr) if (f[i].li_attr.hasOwnProperty(k)) {
          if ("id" === k) continue;
        ...
        if (f[i] && f[i].a_attr !== b && "object" == _typeof(f[i].a_attr)) for (k in f[i].a_attr) if (f[i].a_attr.hasOwnProperty(k)) {
          if ("id" === k) continue;
        ...
        if (f[d].li_attr !== b && "object" == _typeof(f[d].li_attr)) for (k in f[d].li_attr) if (f[d].li_attr.hasOwnProperty(k)) {
          if ("id" === k) continue;
        ...
        if (f[d].a_attr !== b && "object" == _typeof(f[d].a_attr)) for (k in f[d].a_attr) if (f[d].a_attr.hasOwnProperty(k)) {
          if ("id" === k) continue;
...
/******/ 	var __webpack_exports__ = __webpack_require__("./resources/assets/vendor/libs/file-manager/jstree.min.js");
/******/ 	
