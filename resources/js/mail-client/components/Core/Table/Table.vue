...
import ActionSelect from '../../../components/Core/Actions/ActionsSelect.vue'
import TablePagination from './TablePagination.vue'
import Collection from './Collection'
import FiltersDropdown from '../../../components/Core/Filters/FilterDropdown.vue'
import Filters from '../../../components/Core/Filters'
import { useFilterable } from '../../../components/Core/Filters/useFilterable'
import { useQueryBuilder } from '../../../components/Core/QueryBuilder/useQueryBuilder'
...
import RulesDisplay from '../../../components/Core/QueryBuilder/RulesDisplay.vue'
import { CancelToken } from '../../../composables/Core/services/HTTP'
...
const searchInputIsDisabled = computed(
  () => isLoading.value && search.value.length > 0
)
...
const { hasRules } = useFilterable(filtersIdentifier, filtersView)
