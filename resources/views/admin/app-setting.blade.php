                            ...
                            <form method="POST" action="{{ route('admin.setting.store') }}">
                                ...
                                <div class="row">
                                    <div class="col-md-6 mb-3">
                                        ...
                                        <input name="timeout_warning_seconds" type="text" class="form-control" id="timeoutWarningIn" placeholder="{{ __('Timeout warning after x seconds') }}" aria-describedby="timeoutWarningIn" />
                                    ...
                                    <div class="col-md-6 mb-3">
                                        ...
                                        <input name="timeout_after_seconds" type="text" class="form-control" id="timeoutAfter" placeholder="{{ __('Timeout after x amount of seconds') }}" aria-describedby="timeoutAfter" />
