...
@section('breadcrumb')
    <div class="col-md-12">
        ...
        <ul class="breadcrumb">
            ...
            <li class="breadcrumb-item">{!! Html::link(route('admin.applications.settings.form-templates.index'), __('Form Templates'), ['']) !!}</li>
        ...
        <div class="main-content">
            ...
            <section class="section">
                <div class="section-body">
                    {{ Form::model($formTemplate, ['route' => ['admin.applications.settings.form.template.design.update', $formTemplate->id], 'method' => 'PUT', 'id' => 'design-form']) }}
                    <div class="row">
