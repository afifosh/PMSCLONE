...
@if ($data !== null || $type == 'Admin' || $type == 'public')
    <div class="section-body">
                ...
                @else
                    <div class="card">
                        ...
                        <div class="card-body form-card-body">
                            <form action="{{ route('admin.applications.settings.forms.fill.store', $form->id) }}" method="POST"
                                            ...
                                            <div class="row">
                                                @foreach ($rows as $row_key => $row)
                                                    ...
                                                    @elseif($row->type == 'file')
                                                        ...
                                                        <div class="form-group {{ $col }}"
                                                            ...
                                                            @if ($row->subtype == 'fineuploader')
                                                                ...
                                                                @include('admin.pages.applications.form.js.dropzone')
                                                    ...
                                                    @elseif($row->type == 'autocomplete')
                                                        <div class="form-group {{ $col }}"
                                                            data-name={{ $row->name }}>
                                                            {{-- @include('admin.pages.applications.form.js.autocomplete') --}}
                                                            @php
                                                                $attr = ['class' => 'form-select w-100', 'id' => 'sschoices-multiple-remove-button', 'data-trigger'];
                                                                if ($row->required) {
                                                                    $attr['required'] = 'required';
                                                    ...
                                                    @elseif($row->type == 'SignaturePad')
                                                        ...
                                                        <div class="row form-group {{ $col }}"
                                                            data-name={{ $row->name }}>
                                                            @include('admin.pages.applications.form.js.signature')
                                                            <div class="col-12">
                                                                <label for="{{ $row->name }}"
                                                                    class="form-label">{{ $row->label }}</label>
                                                                @if ($row->required)
                                                    ...
                                                    @elseif($row->type == 'location')
                                                        <div class="form-group {{ $col }}"
                                                            data-name={{ $row->name }}>
                                                            @include('admin.pages.applications.form.js.map')
                                                    ...
                                                    @elseif($row->type == 'video')
                                                        ...
                                                        <div class="row form-group {{ $col }}"
                                                            data-name={{ $row->name }}>
                                                            @include('admin.pages.applications.form.js.video')
                                                            <label for="{{ $row->name }}"
                                                                class="form-label">{{ $row->label }}</label>
                                                            @if ($row->required)
                                                                <span class="text-danger align-items-center">*</span>
                                                    ...
                                                    @elseif($row->type == 'selfie')
                                                        ...
                                                        <div class="row {{ $col }} selfie_screen"
                                                            data-name={{ $row->name }}>
                                                            @include('admin.pages.applications.form.js.selfie')
        ...
        @if ($form->allow_share_section == 1)
            <div class="row">
                @include('admin.pages.applications.form.js.share-section')
                    ...
                    <div class="card">
                        ...
                        <div class="card-body ">
                            <div class="m-auto form-group col-6">
                                ...
                                <div class="input-group">
                                    <input type="text" value="{{ route('admin.applications.settings.forms.survey', $id) }}"
                                ...
                                <div class="mt-3 social-links-share">
                                    <a href="https://api.whatsapp.com/send?text={{ route('admin.applications.settings.forms.survey', $id) }}"
                                        title="Whatsapp" class="social-links-share-main">
                                        <i class="ti ti-brand-whatsapp"></i>
                                    </a>
                                    <a href="https://twitter.com/intent/tweet?text={{ route('admin.applications.settings.forms.survey', $id) }}"
                                        title="Twitter" class="social-links-share-main">
                                        <i class="ti ti-brand-twitter"></i>
                                    </a>
                                    <a href="https://www.facebook.com/share.php?u={{ route('admin.applications.settings.forms.survey', $id) }}"
                                        title="Facebook" class="social-links-share-main">
                                        <i class="ti ti-brand-facebook"></i>
                                    </a>
                                    <a href="https://www.linkedin.com/sharing/share-offsite/?url={{ route('admin.applications.settings.forms.survey', $id) }}"
                                        title="Linkedin" class="social-links-share-main">
                                        <i class="ti ti-brand-linkedin"></i>
                                    </a>
                                    <a href="javascript:void(1);" class="social-links-share-main"
                                        title="Show QR Code" data-action="{{ route('admin.applications.settings.forms.survey.qr', $id) }}"
                                        id="share-qr-image">
                                    ...
                                    <a href="javascript:void(0)" title="Embed" class="social-links-share-main"
                                        ...
                                        data-url='<iframe src="{{ route('admin.applications.settings.forms.survey', $id) }}" scrolling="auto" align="bottom" style="height:100vh;" width="100%"></iframe>'>
        ...
        @if ($form->allow_comments == 1)
            <div class="row">
                <div class="mx-auto col-xl-7 order-xl-1">
                    <div class="card">
                        <div class="card-header">
                            <h5> <i class="me-2" data-feather="message-circle"></i>Comments</h5>
                        </div>
                        {!! Form::open([
                            'route' => 'admin.applications.settings.form.comment.store',
                            'method' => 'Post',
                        ]) !!}
                        <div class="card-body">
                            <div class="form-group">
                        ...
                        <div class="card-footer">
                            <div class="text-end">
                                <button class="btn btn-primary">{{__('Add a comment')}}</button>
                            </div>
                            {!! Form::close() !!}
                            @foreach ($form->commmant as $value)
                                    ...
                                    <span class="text-left comment-info">
                                        ...
                                        <h6 class="d-block">
                                            ...
                                            @if (Auth::user())
                                                {!! Form::open([
                                                    'method' => 'DELETE',
                                                    'route' => ['admin.applications.settings.form.comment.destroy', $value->id],
                                ...
                                {!! Form::open([
                                    'route' => 'admin.applications.settings.form.comment.reply.store',
                                    'method' => 'Post',
                                    'data-validate',
                                ]) !!}
...
@if ($form->conditional_rule == '1')
    @include('admin.pages.applications.form.js.conditional-rule')
@endif
@push('scripts')
