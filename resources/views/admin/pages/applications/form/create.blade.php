...
@section('content')
    <div class="row">
        {!! Form::open([
            'route' => ['admin.applications.settings.forms.store'],
            'method' => 'POST',
            'data-validate',
            'id' => 'payment-form',
                ...
                <div class="card">
                    ...
                    <div class="card-footer">
                        <div class="text-end">
                            ...
                            {!! Form::button(__('Save'), ['type' => 'submit', 'class' => 'btn btn-primary', 'data-form' => "ajax-form"]) !!}
                        </div>
                    </div>
                </div>
            </div>
...
@push('scripts')
    ...
    <script>
        CKEDITOR.replace('success_msg', {
            filebrowserUploadUrl: "{{ route('admin.applications.settings.ckeditors.upload', ['_token' => csrf_token()]) }}",
