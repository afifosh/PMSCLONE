        ...
        <div class="d-flex justify-content-between">
            <div class="previous-next-btn">
                ...
                <ul class="breadcrumb">
                    ...
                    <li class="breadcrumb-item"><a href="{{ route('admin.applications.settings.forms.index') }}">{{ __('Forms') }}</a></li>
    ...
    <div class="row">
        <div class="col-lg-12">
            <div class="card">
                ...
                {!! Form::open([
                    'route' => ['admin.applications.settings.form.theme.change', $form->id],
                    'method' => 'POST',
                    'novalidate',
                    'data-validate',
                ]) !!}
                    ...
                    <div class="uploaded-pics gy-3 row">
                        <div
                            ...
                            <div class="theme-view-inner theme-view-hover">
                                ...
                                <div class="theme-button"><button
                                        data-url="{{ route('admin.applications.settings.form.theme.edit', ['theme1', $form->id]) }}"
                        ...
                        <div
                            ...
                            <div class="theme-view-inner theme-view-hover">
                                ...
                                <div class="theme-overlay"></div>
                                <div class="theme-button"><button
                                        data-url="{{ route('admin.applications.settings.form.theme.edit', ['theme2', $form->id]) }}"
                                        class="btn btn-primary btn-sm selectTheme" type="button"><i
                                            class="ti ti-edit"></i></button>
                                </div>
                            </div>
                        ...
                        <div
                            ...
                            <div class="theme-view-inner theme-view-hover">
                                ...
                                <div class="theme-button">
                                    <button data-url="{{ route('admin.applications.settings.form.theme.edit', ['theme3', $form->id]) }}"
                                        class="btn btn-primary btn-sm selectTheme" type="button"><i
                                            class="ti ti-edit"></i></button>
                                </div>
                            </div>
                        ...
                        <div
                            ...
                            <div class="theme-view-inner theme-view-hover">
                                ...
                                <div class="theme-overlay"></div>
                                <div class="theme-button"><button
                                        data-url="{{ route('admin.applications.settings.form.theme.edit', ['theme4', $form->id]) }}"
                                        class="btn btn-primary btn-sm selectTheme" type="button"><i
                                            class="ti ti-edit"></i></button>
                                </div>
                            </div>
                        ...
                        <div
                            ...
                            <div class="theme-view-inner theme-view-hover">
                                ...
                                <div class="theme-overlay"></div>
                                <div class="theme-button"><button
                                        data-url="{{ route('admin.applications.settings.form.theme.edit', ['theme5', $form->id]) }}"
                                        class="btn btn-primary btn-sm selectTheme" type="button"><i
                                            class="ti ti-edit"></i></button>
                                </div>
                            </div>
                        ...
                        <div
                            ...
                            <div class="theme-view-inner theme-view-hover">
                                ...
                                <div class="theme-overlay"></div>
                                <div class="theme-button"><button
                                        data-url="{{ route('admin.applications.settings.form.theme.edit', ['theme6', $form->id]) }}"
                                        class="btn btn-primary btn-sm selectTheme" type="button"><i
                                            class="ti ti-edit"></i></button>
                                </div>
                            </div>
                        ...
                        <div
                            ...
                            <div class="theme-view-inner theme-view-hover">
                                ...
                                <div class="theme-overlay"></div>
                                <div class="theme-button"><button
                                        data-url="{{ route('admin.applications.settings.form.theme.edit', ['theme7', $form->id]) }}"
                                        class="btn btn-primary btn-sm selectTheme" type="button"><i
                                            class="ti ti-edit"></i></button>
                                </div>
                            </div>
                        ...
                        <div
                            ...
                            <div class="theme-view-inner theme-view-hover">
                                ...
                                <div class="theme-overlay"></div>
                                <div class="theme-button"><button
                                        data-url="{{ route('admin.applications.settings.form.theme.edit', ['theme8', $form->id]) }}"
                                        class="btn btn-primary btn-sm selectTheme" type="button"><i
                                            class="ti ti-edit"></i></button>
                                </div>
                            </div>
                ...
                <div class="card-footer">
                    <div class="text-end">
                        {!! Html::link(route('admin.applications.settings.forms.index'), __('Cancel'), ['class' => 'btn btn-secondary']) !!}
