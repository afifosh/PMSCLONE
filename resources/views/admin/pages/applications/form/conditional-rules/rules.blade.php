...
@section('content')
    <div class="row">
        <div class="col-lg-8 col-md-8 col-sm-12 col-12 m-auto">
            {{ Form::open(['route' => 'admin.applications.settings.rule.store', 'method' => 'post', 'id' => 'form-rule', 'data-validate', 'no-validate']) }}
            <div class="card">
                            ...
                            <div class="row">
                                ...
                                <div class="col-10">
                                    <div class="repeater">
                                        <div data-repeater-list="rules">
                                            <div data-repeater-item class="border-bottom py-2">
                                                <div class="row count-row">
                                                    ...
                                                    <div class="col-lg-1">
                                                        <button data-repeater-delete class="btn btn-danger p-2"
                                        ...
                                        <div class="col-lg-1">
                                            <button data-repeater-create class="btn btn-primary p-2 add-repeater-button"
                            ...
                            <div class="row">
                                ...
                                <div class="col-10">
                                    <div class="repeater2">
                                        ...
                                        <div class="col-lg-1">
                                            <button data-repeater-create class="btn btn-primary p-2 " type="button"
                        ...
                        @if (is_array($rules) || is_object($rules))
                            ...
                            @foreach ($rules as $rule)
                                <tr>
                                    ...
                                    <td>
                                        <a href="{{ route('admin.applications.settings.rule.edit', $rule->id) }}"><button
                                                class="btn btn-primary btn-sm small">{{ __('Edit') }}</button></a>
                                        <a href="#" class="btn btn-sm small btn-danger"
                                            data-bs-toggle="tooltip" data-bs-placement="bottom"
                                            id="delete-form-{{ $rule->id }}"
                                            data-bs-original-title="{{ __('Cancel Rule') }}"
                                            aria-label="{{ __('Cancel Rule') }}"
                                            data-toggle="ajax-delete"
                                            data-href="{{route('admin.applications.settings.rule.delete', $rule->id)}}"
                                            >{{ __('Delete') }}</a>
                                    </td>
                                </tr>
                            @endforeach
...
@push('scripts')
    ...
    <script>
        ...
        $(document).on('change', '.if_field_name', function() {
            ...
            $.ajax({
                type: "GET",
                url: "{{ route('admin.applications.settings.get.field') }}",
                data: {
                    id: id,
                    fieldname: fieldName
                },
