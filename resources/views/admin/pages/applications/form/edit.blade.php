        ...
        <div class="d-flex justify-content-between">
            ...
            <div class="float-end">
                <div class="d-flex align-items-center">
                    <a href="@if (!empty($previous)) {{ route('admin.applications.settings.forms.edit', [$previous->id]) }}@else javascript:void(0) @endif"
                        type="button" class="btn btn-outline-primary"><i class="me-2"
                            data-feather="chevrons-left"></i>{{ __('Previous') }}</a>
                    <a href="@if (!empty($next)) {{ route('admin.applications.settings.forms.edit', [$next->id]) }}@else javascript:void(0) @endif"
...
@section('content')
    <div class="row">
        {{ Form::model($form, ['route' => ['admin.applications.settings.forms.update', $form->id], 'data-validate', 'method' => 'PUT', 'class' => 'form-horizontal', 'enctype' => 'multipart/form-data']) }}
        <div class="row">
            <div class="col-sm-6">
                <div class="card">
...
@push('scripts')
    ...
    <script>
        ...
        CKEDITOR.replace('success_msg', {
            filebrowserUploadUrl: "{{ route('admin.applications.settings.ckeditor.upload', ['_token' => csrf_token()]) }}",
