...
<div class="row">
  <div class="col-md-12">
    <ul class="nav nav-pills flex-column flex-md-row mb-4">
      ...
      <li class="nav-item"><a class="nav-link" href="{{ route('admin.admin-account.edit', ['admin_account' => auth()->id(), 't' => 'security'])}}"><i class="ti-xs ti ti-lock me-1"></i> Security</a></li>
      ...
      <li class="nav-item"><a class="nav-link" href="{{route('admin.account.settings.notifications')}}"><i class="ti-xs ti ti-bell me-1"></i> Notifications</a></li>
        ...
        <form method="POST" action="{{ route('admin.user-profile-information.update') }}">
          ...
          <div class="row">
            <div class="mb-3 col-md-6">
              ...
              <input class="form-control" type="text" id="firstName" name="first_name" value="{{ auth()->user()->first_name }}" autofocus />
            </div>
            <div class="mb-3 col-md-6">
            ...
            {{-- <div class="mb-3 col-md-6">
              ...
              <input type="text" class="form-control" id="organization" name="company_id" value="" disabled/>
            </div> --}}
            <div class="mb-3 col-md-6">
              <label class="form-label" for="phoneNumber">Phone Number</label>
              <div class="input-group input-group-merge">
                <span class="input-group-text">US (+1)</span>
                <input type="text" id="phoneNumber" name="phone" class="form-control" placeholder="Phone" value="{{ auth()->user()->phone }}" />
              </div>
            </div>
            <div class="mb-3 col-md-6">
