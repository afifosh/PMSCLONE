...
<div class="row">
  <div class="col-md-12">
    <ul class="nav nav-pills flex-column flex-sm-row mb-4">
      ...
      <li class="nav-item"><a class="nav-link {{$tab == 'invoices' ? 'active' : ''}}" href="{{ route('admin.programs.invoices.index', ['program' => $program->id])}}"><i class='ti-xs ti ti-users me-1'></i> Invoices</a></li>
      <li class="nav-item"><a class="nav-link {{$tab == 'payments' ? 'active' : ''}}" href="{{ route('admin.programs.payments.index', ['program' => $program->id])}}"><i class='ti-xs ti ti-users me-1'></i> Payments</a></li>
