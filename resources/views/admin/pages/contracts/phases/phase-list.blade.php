    ...
    <div class="email-list-item todo-item d-flex align-items-center fw-bold task-header">
      ...
      <div class="email-list-item-meta ms-auto d-flex align-items-center">
        ...
        <ul class="list-unstyled el-foh">
          <li class="m-0 me-2 p-0" data-href="{{route('admin.projects.contracts.stages.phases.edit', ['project' => $project, $contract, 'stage' => $stage, $phase])}}" data-toggle="ajax-modal" data-title="Edit Phase"> <i class="ti ti-edit"></i> </li>
          <li class="m-0 me-2 p-0" data-href="{{route('admin.projects.contracts.stages.phases.destroy', ['project' => $project, $contract, 'stage' => $stage, $phase])}}" data-toggle="ajax-delete"> <i class="ti ti-trash"></i> </li>
        </ul>
      </div>
    </div>
  </li>
