<div class="d-inline-block text-nowrap">
  ...
  <button class="btn btn-sm btn-icon" data-toggle="ajax-modal" data-href="{{route('admin.contracts.change-requests.reviews.create', ['contract' => $change_request->contract_id, 'change_request' => $change_request])}}"><i class="fa fa-wrench"></i></button>
  @endif
