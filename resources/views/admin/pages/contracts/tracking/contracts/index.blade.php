...
@section('title', 'Contracts Tracking Review')
    ...
    <div class="card h-100">
      <div class="card-header">
        <div class="d-flex justify-content-between mb-3">
          <h5 class="card-title mb-0">{{__('Contracts Tracking Review')}}</h5>
        </div>
      </div>
      <form class="js-datatable-filter-form">
        <div class="d-flex justify-content-between align-items-center row pb-2 gap-3 mx-3 gap-md-0">
          ...
          <div class="col">
            {!! Form::label('contract_reviewer', 'Reviewer') !!}
            {!! Form::select('contract_reviewer', [], 'all', [
          ...
          <div class="col">
            {!! Form::label('contract_review_status', 'Review Status') !!}
            {!! Form::select('contract_review_status', $review_status, 'all', [
...
$('#contracts-table tbody').on('click', '.btn-expand', function() {
