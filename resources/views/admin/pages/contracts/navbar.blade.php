  ...
  <div class="card">
    <div class="p-3">
      <ul class="nav nav-pills flex-column flex-md-row">
        ...
        <li class="nav-item"><a class="nav-link {{ $tab == 'phases' ? 'active' : '' }}" href="{{route('admin.projects.contracts.index', $project)}}"><i class="fa-regular fa-check-circle menu-icon me-1"></i> Contracts</a></li>
      </ul>
    </div>
  </div>
</div>
