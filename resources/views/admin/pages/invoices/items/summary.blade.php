...
@if ($invoice->paid_amount)
  ...
  <div class="d-flex justify-content-between">
    ...
    <span class="fw-semibold">@money($invoice->paid_amount, $invoice->contract->currency, true)</span>
  </div>
@endif
...
<div class="d-flex justify-content-between">
  ...
  <span class="fw-semibold">@money($invoice->total - $invoice->paid_amount - $invoice->retention_amount, $invoice->contract->currency, true)</span>
</div>
