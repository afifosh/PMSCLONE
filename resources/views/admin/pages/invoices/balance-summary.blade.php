<tr>
  <td class="x-payments-lang">Total Due : </td>
  <td class="x-payments"> <a ><span class="p-l-20">@cMoney($invoice->payableAmount() + $invoice->retention_amount, $invoice->contract->currency, true)</span></a></td>
</tr>
<tr>
  <td class="x-payments-lang">Retention : </td>
  <td class="x-payments"> <a ><span class="p-l-20">@cMoney($invoice->retention_amount, $invoice->contract->currency, true)</span></a></td>
</tr>
<tr>
...
<tr>
  <td class="x-payments-lang">Paid : </td>
