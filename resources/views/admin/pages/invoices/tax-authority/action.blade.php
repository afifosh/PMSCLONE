<div class="d-inline-block text-nowrap">
  ...
  <div class="dropdown-menu dropdown-menu-end m-0">
      <a data-toggle="ajax-modal" data-title="{{__('Add Payment')}}" data-href="{{route('admin.finances.payments.create',['invoice' => $invoice->id, 'type' => 'tax-authority'])}}" class="dropdown-item">{{__('Add Payment')}}</a>
  </div>
</div>
