...
@section('title', 'Tax Authority Invoices')
          ...
          <div class="d-flex justify-content-between align-items-center row pb-2 gap-3 mx-3 gap-md-0">
            <div class="col-4">
              ...
              {!! Form::select('filter_contract', [], [], [
                ...
                'data-url' => route('resource-select', ['Contract', 'has-ta-inv', 'companies' => $company->id])
              ]) !!}
            </div>
            <div class="col-4">
    ...
    <script>
      $(document).ready(function () {
          $('.js-datatable-filter-form :input').on('change', function (e) {
              window.LaravelDataTables["authority-invoices-table"].draw();
          });

          $('#authority-invoices-table').on('preXhr.dt', function ( e, settings, data ) {
      ...
      function toggleCheckboxes(){
        $('#authority-invoices-table').DataTable().column(0).visible(!$('#authority-invoices-table').DataTable().column(0).visible());
        $('#authority-invoices-table').DataTable().ajax.reload(null, false);
      }
    </script>
@endpush
