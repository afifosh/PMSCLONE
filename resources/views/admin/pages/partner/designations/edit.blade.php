...
<div class="row">
    ...
    <div class="form-group">
      ...
      {!! Form::select('company', $companies, @$designation->company->id ?? null, ['class' => 'form-select globalOfSelect2']) !!}
    </div>

    <div class="form-group">
      {{ Form::label('department', __('Department'), ['class' => 'col-form-label']) }}
      {!! Form::select('department', $departments, $designation->department_id, ['class' => 'form-select globalOfSelect2']) !!}
    </div>
</div>
