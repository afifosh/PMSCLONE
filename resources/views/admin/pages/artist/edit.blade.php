          ...
          <div class="row">
            ...
            <div class="mb-3 col-md-6">
              <label class="form-label" for="phone">Phone Number</label>
                <input type="text" id="phone" name="phone" class="form-control" value="{{old('phone') ?? $artist->phone}}"/>
            ...
            <div class="mb-3 col-md-6">
              ...
              <input type="text" class="form-control" id="address" name="address" value="{{ old('address') ?? $artist->address }}" placeholder="Address" />
