...
@section('page-script')
<script src={{asset('assets/js/custom/admin-company-roles-permissions.js')}}></script>
...
<!-- Add Role Modal -->
@include('admin/_partials/_modals/modal-add-company-role')
