                    ...
                    <div class="setting-item">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6 mb-4">
                                ...
                                <select id="provider" data-tokens="{{ route('admin.setting.delivery.show') }}" data-attr="{{ $settings['provider'] ?? '' }}" class="w-100" {{--selectpicker--}} data-style="btn-default" data-live-search="true">
