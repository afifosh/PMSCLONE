...
{{-- <h4 class="fw-bold py-3 mb-4">
  <span class="text-muted fw-light">Draft RFP /</span> Profile
</h4> --}}
...
<div class="row">
  <div class="col-md-12">
    <ul class="nav nav-pills flex-column flex-sm-row mb-4">
      ...
      <li class="nav-item"><a class="nav-link" href="{{ route('admin.draft-rfps.show', ['draft_rfp' => $draft_rfp, 'program' => $draft_rfp->program_id, 'tab' => 'program-users']) }}"><i class='ti-xs ti ti-users me-1'></i> Users</a></li>
