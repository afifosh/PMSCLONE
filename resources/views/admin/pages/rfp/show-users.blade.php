...
<div class="row">
  <div class="col-md-12">
    <ul class="nav nav-pills flex-column flex-sm-row mb-4">
      <li class="nav-item"><a class="nav-link" href="{{ route('admin.draft-rfps.show', ['draft_rfp' => $draft_rfp]) }}"><i class='ti-xs ti ti-user-check me-1'></i> Profile</a></li>
      <li class="nav-item"><a class="nav-link active" href="javascript:void(0)"><i class='ti-xs ti ti-users me-1'></i> Users</a></li>
    <li class="nav-item"><a class="nav-link" href="{{ route('admin.draft-rfps.show', ['draft_rfp' => $draft_rfp, 'tab' => 'files']) }}"><i class='ti-xs ti ti-layout-grid me-1'></i> Files</a></li>
      <li class="nav-item"><a class="nav-link" href="javascript:void(0)"><i class='ti-xs ti ti-link me-1'></i> Connections</a></li>
    </ul>
  </div>
</div>
<!--/ Navbar pills -->
