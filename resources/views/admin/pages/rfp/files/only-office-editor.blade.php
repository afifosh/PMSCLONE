          ...
          <div>
            <div class="btn-group">
              ...
              <ul class="dropdown-menu">
                <li><a class="dropdown-item" href="{{route('admin.draft-rfps.files.download', ['draft_rfp' => $file->rfp_id, 'file' => $file])}}">Download</a></li>
                <li><a class="dropdown-item" href="{{ route('admin.shared-files.file-activity', ['file' => $file->id, 'rfp' => $draft_rfp])}}">File Activity</a></li>
                <li><a class="dropdown-item" href="{{ route('admin.shared-files.file-versions', ['file' => $file->id, 'rfp' => $draft_rfp])}}">Versions History</a></li>
              </ul>
            </div>
          </div>
        </div>
