...
<div class="app-content content file-manager-application">
  ...
  <div class="content-area-wrapper d-flex container-xxl p-0">
              ...
              <div class="sidebar-file-manager">
                  <div class="sidebar-inner">
                      ...
                      <div class="dropdown dropdown-actions">
                          <button class="btn btn-primary add-file-btn text-center w-100" type="button" id="addNewFile" data-bs-toggle="modal" data-bs-target="#add-file-modal">
