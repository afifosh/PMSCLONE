<div class="d-flex items-center justify-content-center pe-2"><span
        class="text-light p-2 position-absolute mx-auto mt-2 inline-block overflow-hidden text-truncate text-center fw-bold">
        {{$text}}
    </span> <svg width="38px" height="51px" fill="currentColor" viewBox="0 0 38 51" version="1.1"
        xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"
        class="vue-feather dark:text-gray-800 text-gray-100" style="fill: black;">
        <path
