    ...
    <div class="modal-content p-3 p-md-5">
      <div class="modal-body">
        ...
        {{-- <form class="row g-3" action="{{route('admin.two-factor.confirm')}}" method="POST">
          @csrf --}}
          <form class="row g-3" action="{{route('admin.security.setting',['active_tab'=>'two-factor-authentication']) }}" method="POST">          
            @csrf
            <input type="hidden" id="two-factor-action" name="action" value="confirm">
            <input type="hidden" id="two-factor-endpoint" name="endpoint" value="two-factor-authentication">             
          <div class="col-12">
