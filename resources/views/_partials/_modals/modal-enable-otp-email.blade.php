  ...
  <div class="modal-dialog modal-simple modal-enable-otp modal-dialog-centered">
    <div class="modal-content p-3 p-md-5">
      <div class="modal-body">
        ...
        <form class="row g-3" action="{{route('user.security.setting',['active_tab'=>'two-factor-email-authentication']) }}" method="POST">          
          @csrf
        ...
        {{-- <form class="row g-3" action="{{route('user.two-factor-email.confirm')}}" method="POST"> --}}
