...
@section('title', 'Account settings - Auth Logs')
...
<h4 class="fw-bold py-3 mb-4">
  <span class="text-muted fw-light">Account Settings /</span> Authentication Logs
</h4>
...
<div class="row">
  <div class="col-md-12">
    ...
    <div class="card mb-4">
      <h5 class="card-header">{{ __('Authentication Logs') }}</h5>
      <div class="card-body">
        {{ $dataTable->table() }}
      </div>
    </div>
