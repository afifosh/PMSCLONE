...
<div class="row">
  <div class="col-md-12">
    ...
    <div class="card mb-4">
      ...
      <div class="card-body">
          {{-- <form method="POST" action="{{route('user-account.update', ['user_account' => auth()->id()])}}"> --}}
...
<!----------------------------------------------------------------------->
  ...
  @include('_partials/_modals/modal-enable-otp-email')
  @include('_partials/_modals/modal-otp-confirm-password')    
  <!-- /Modal -->
