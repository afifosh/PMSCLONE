...
<div class="card-body">
  <div class="d-flex align-items-start align-items-sm-center gap-4">
    <img src="{{ auth('web')->user()->company->avatar }}" alt="user-avatar" class="d-block w-px-100 h-px-100 rounded" id="uploadedAvatar" />
...
<div class="row g-3">
  ...
  <hr>
  <div class="form-check form-switch col-sm-6">
    <input class="form-check-input" name="is_parent" {{isset($detail['subsidiaries'][0]) ? 'checked' : ''}} data-switch-toggle="#sub-company" type="checkbox" id="pc-confirmation">
