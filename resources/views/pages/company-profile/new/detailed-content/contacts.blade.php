<div class="content-header mb-3 d-sm-flex justify-content-between">
  <div>
    ...
    <small>Manage Contact Persons</small>
  </div>
  <div>
    @if (auth()->user()->company->isEditable())
      <div class="d-flex justify-content-between">
        <button class="btn btn-primary" data-toggle="ajax-modal" data-title="Add New Contact Person" data-href="{{ route('company.contacts.create') }}">Add New</button>
      </div>
    @endif
  </div>
</div>
      ...
      <div class="form-check custom-option custom-option-basic">
        <label class="form-check-label custom-option-content">
          <span class="custom-option-header mb-2">
            ...
            <span class="badge bg-label-{{@$contact['id'] ? 'primary' : 'warning'}}">
