...
<div class="row">
  ...
  <div class="form-group col-6">
      ...
      {!! Form::text('name', null, ['class' => 'form-control', 'placeholder' => __('Bank Name')]) !!}
  </div>
  <div class="form-group col-6">
    {{ Form::label('branch', __('Branch'), ['class' => 'col-form-label']) }}
    {!! Form::text('branch', null, ['class' => 'form-control', 'placeholder' => __('Branch')]) !!}
  </div>
  <div class="form-group col-6">
    {{ Form::label('street', __('Street'), ['class' => 'col-form-label']) }}
    {!! Form::text('street', null, ['class' => 'form-control', 'placeholder' => __('Street')]) !!}
  </div>
  <div class="form-group col-6">
  ...
  <div class="form-group col-6">
    ...
    {!! Form::text('post_code', null, ['class' => 'form-control', 'placeholder' => __('Postal Code')]) !!}
  </div>
  <div class="form-group col-6">
    {{ Form::label('account_no', __('Account Number'), ['class' => 'col-form-label']) }}
    {!! Form::text('account_no', null, ['class' => 'form-control', 'placeholder' => __('Account Number')]) !!}
  </div>
  <div class="form-group col-6">
    {{ Form::label('iban_no', __('IBAN Number'), ['class' => 'col-form-label']) }}
    {!! Form::text('iban_no', null, ['class' => 'form-control', 'placeholder' => __('IBAN Number')]) !!}
  </div>
  <div class="form-group col-6">
    {{ Form::label('swift_code', __('Swift Code'), ['class' => 'col-form-label']) }}
    {!! Form::text('swift_code', null, ['class' => 'form-control', 'placeholder' => __('Swift Code')]) !!}
  </div>
</div>
<div class="mt-3">
