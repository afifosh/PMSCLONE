...
(function (global) {
  ...
  ZTGantt.prototype = {
    ...
    createBody: function (
      ...
      if (this.options.addTaskOnDrag === true && this.options.view_mode != "readonly") {
    ...
    createTaskBars: function (barContainer = null, isFromRender = false) {
      ...
      for (let j = 0; j < this.options.data.length; j++) {
        ...
        // Prevent the default action (if any) associated with the double click.
        e.preventDefault();

        // If options.view_mode is true, we'll stop the further execution of the function.
        if (options.view_mode) {
