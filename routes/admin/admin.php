...
use App\Http\Controllers\Admin\Contract\ChangeRequestReviewController;
...
Route::prefix('contracts')->group(function () {
  ...
  dd($data);
    ...
    Route::middleware('contractACL')->group(function () {
      ...
      Route::resource('contracts.change-requests.reviews', ChangeRequestReviewController::class)->only(['create', 'store']);
