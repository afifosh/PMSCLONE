...
use Modules\Chat\Http\Requests\CreateUserStatusRequest;
use Modules\Chat\Http\Requests\UpdateUserNotificationRequest;
...
class UserAPIController extends AppBaseController
{
    ...
    public function updatePlayerId(Request $request): JsonResponse
    {
        ...
        $deviceRepo = FacadesApp::make(UserDeviceRepository::class);
