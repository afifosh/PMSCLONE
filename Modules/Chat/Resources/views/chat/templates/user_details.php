<script id="tmplUserDetails" type="text/x-jsrender">
    ...
    <div class="chat-profile__column chat-profile__column--media">
        <h6 class="chat-profile__column-title"><?php echo trans('chat::messages.media') ?></h6>
    ...
    <div class="chat-profile__column">
        <h6 class="chat-profile__column-title"><?php echo trans('chat::messages.common_group') ?>
    ...
    <div class="chat-profile__divider"></div>
    <div class="chat-profile__column">
        <button type="button" class='btn btn-danger open-report-user-modal' id="open-report-user-modal" data-id="{{:id}}" {{:~disabledIfReported(reported_user)}}><?php echo trans('chat::messages.report_user') ?></button>
    </div>
    {{/if}}
</div>
</script>
