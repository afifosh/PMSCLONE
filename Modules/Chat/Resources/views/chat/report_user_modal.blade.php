    ...
    <div class="modal-dialog modal-dialog-centered">
        ...
        <div class="modal-content">
            <div class="modal-header border-0 pb-0">
                <h5 class="modal-title">{{__('chat::messages.report_user')}}</h5>
            ...
            <div class="modal-body">
                ...
                <div class="col-sm-12">
                    {!! Form::label('note', __('chat::messages.notes')) !!}<span class="red">*</span>
