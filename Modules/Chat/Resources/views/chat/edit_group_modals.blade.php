    ...
    <div class="modal-dialog">
        ...
        <div class="modal-content">
            <div class="modal-header">
                <h4 class="modal-title group-modal-title">{{ __('chat::messages.group.edit_group') }}</h4>
            ...
            <div class="modal-body">
                ...
                <div class="row">
                    <div class="col-12 mb-3">
                        {!! Form::label('name', __('chat::messages.group.name')) !!}<span class="red">*</span>
                        {!! Form::text('name', null, ['class' => 'form-control login-group__input', 'required', 'id' => 'editGroupName','placeholder'=> __('chat::messages.group.name')]) !!}
                    </div>
                    <div class="col-12 d-flex edit-profile-image mb-3">
                        <div class="ps-0 edit-profile-btn">
                            {!! Form::label('photo', 'Group Icon'.':') !!}
                            <label class="edit-profile__file-upload btn-primary"> {{__('chat::messages.group.choose_file')}}
                    ...
                    <div class="col-12">
                        <div class="col-12 div-group-type d-flex ps-0 mb-3">
                            <div class="pe-3">
                                {!! Form::label('type', __('chat::messages.group.type')).":" !!}<span class="red">*</span>
                            </div>
                        ...
                        <div class="col-12 div-group-privacy mt-4 d-flex ps-0 mb-3">
                            <div class="pe-3">
                                {!! Form::label('privacy', __('chat::messages.group.privacy')).":" !!}<span
                                    class="red">*</span>
                            </div>
                    ...
                    <div class="col-12 mt-3">
                        {!! Form::label('description', __('chat::messages.group.description')) !!}
                        {!! Form::textarea('description', null,['class' => 'form-control login-group__input', 'rows' => 5, 'id' => 'editGroupDesc','placeholder'=>__('chat::messages.group.description')]) !!}
                    </div>
                </div>
                <div class="row mt-3">
                    <div class="col-sm-12 text-start">
                        {!! Form::button(__('chat::messages.save'), ['type'=>'submit','class' => 'btn btn-primary','id'=>'btnEditGroup','data-loading-text' => "<span class='spinner-border spinner-border-sm'></span> Processing..."]) !!}
                        <button type="button" class="btn btn-secondary ms-1"
                                data-bs-dismiss="modal">{{ __('chat::messages.chats.cancel') }}
                        </button>
                    </div>
                </div>
            </div>
