    ...
    <div class="form-group">
        <div class="col-sm-12 d-flex justify-content-around">
            <div class="custom-control custom-checkbox">
                ...
                <label class="custom-control-label" for="newContactMale">{{ __('chat::messages.male') }}</label>
            </div>
            <div class="custom-control custom-checkbox">
                ...
                <label class="custom-control-label" for="newContactFemale">{{ __('chat::messages.female') }}</label>
            </div>
        </div>
    </div>
