<div class="relative">
    <div class="row new-group-members">
        <div class="col-lg-6 col-12 new-members mb-lg-0 mb-2">
            <input
                type="search"
                class="form-control login-group__input mb-3"
                placeholder="{{__('chat::messages.placeholder.search_members')}}"
                wire:ignore
                id="searchMember"
            />
            <ul class="absolute z-10 list-group bg-white w-full group-members-list new-group-members__list">
                @foreach($contacts as $i => $contact)
                    <li class="mb-0 list-group-item group-members-list-chat-select__list-item align-items-center d-flex justify-content-between">
                        <div class="d-flex w-100 align-items-center">
                            ...
                            <div class="truncate-button">
                                ...
                                <div
                                    class="align-self-center add-user-email text-truncate">{{ $contact['email'] }}</div>
                            </div>
                            <span class="btn btn-sm btn-success float-end add-group-member ms-auto"
                                  data-id="{{ $contact['id'] }}">Add</span>
                        </div>
                    </li>
                @endforeach
