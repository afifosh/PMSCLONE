...
<form class="mb-2">
    <input type="search" class="form-control search-input login-group__input" id="searchMyContactForChat"
           placeholder="{{ __('chat::messages.search') }}..." wire:model="searchTerm">
</form>
<div class="form-group">
    <div class="col-sm-12">
        <div class="custom-control custom-checkbox contact-checkbox">
            ...
            <label class="custom-control-label" for="male">{{ __('chat::messages.male') }}</label>
        </div>
        <div class="custom-control custom-checkbox contact-checkbox">
            ...
            <label class="custom-control-label" for="female">{{ __('chat::messages.female') }}</label>
        </div>
        <div class="custom-control custom-checkbox contact-checkbox">
            ...
            <label class="custom-control-label" for="online">{{ __('chat::messages.online') }}</label>
        </div>
        <div class="custom-control custom-checkbox contact-checkbox">
            ...
            <label class="custom-control-label" for="offline">{{ __('chat::messages.offline') }}</label>
        </div>
    </div>
</div>
