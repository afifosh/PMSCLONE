...
; ( function ( factory, global ) {
    ...
    function htmlFromText(str, self) {
      ...
      // Handle custom tag
      // Handle the specific pattern
      return str.replace(/&lt;span userid=&quot;([^&]+)&quot; class=&quot;([^&]+)&quot; contenteditable=&quot;false&quot;&gt;([^&]+)&lt;\/span&gt;/g, function(match, userId, className, content) {
          return '<span userid="' + userId + '" class="' + className + '" contenteditable="false">' + content + '</span>';
      });
    }
    ...
    str = str
        ...
        .replace(/\n<div>/ig, '\n')
        .replace(/<div>\n/ig, '\n\n')
        .replace(/<(?!\/?(span|div)(\sclass="username")?)[^>]*>/g, (match) => {
            // Preserve <span> tag without replacing < and >
