<template>
  <div
    class="-mt-px lg:border-t lg:border-b lg:border-neutral-200 lg:dark:border-neutral-700"
  >
        ...
        >
          ...
          >
            <div v-if="step.status === 'complete'">
              <span
                class="absolute top-0 left-0 h-full w-1 bg-transparent lg:bottom-0 lg:top-auto lg:h-1 lg:w-full"
                aria-hidden="true"
              />
              <span
                :class="[
            ...
            <div v-else-if="step.status === 'current'" aria-current="step">
              <span
                class="absolute top-0 left-0 h-full w-1 bg-primary-600 dark:bg-primary-300 lg:bottom-0 lg:top-auto lg:h-1 lg:w-full"
                aria-hidden="true"
              />
              <span
                :class="[
