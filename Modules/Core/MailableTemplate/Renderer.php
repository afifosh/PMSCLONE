...
use Modules\Core\MailableTemplates\Exceptions\CannotRenderMailableTemplate;
...
class Renderer
{
     ...
     * @return string
     *
     * @throws \Modules\Core\MailableTemplates\Exceptions\CannotRenderMailableTemplate
     */
